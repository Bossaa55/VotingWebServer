...
export const AdminManageEditPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-dvh bg-main p-4">
      ...
      </div>
      {
        ...
        <Card className="shadow-md w-full z-10">
          ...
          <CardContent>
            <form className="flex flex-col items-center justify-center gap-5 px-5 pt-3 mb-3 w-full" onSubmit={handleSubmit}>
              <Input
                type="text"
                name="Nom"
              ...
              <div className={`flex items-center justify-between w-full`}>
                  <button
                    ...
                    className="bg-red-500 text-white font-bold py-2 px-4 rounded flex items-center gap-2"
                  >
                    {isDeleting ? (
                      <>
                        <svg
                ...
                <button
                  type="submit"
                  className="bg-violet-500 text-white font-bold py-2 px-4 rounded items-center gap-2"
                >
                  {isUploading ? (
                    <>
                      <svg
