...
export const AdminLoginPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full px-4 sm:px-0 h-dvh bg-main">
      <BackgroundShapes />
      <NavBar />
        ...
        <CardContent>
          ...
          >
            ...
            <div className="flex items-center justify-end w-full">
              <button
                type="submit"
                className="px-4 py-2 font-bold text-white rounded bg-violet-500 hover:bg-violet-600 focus:outline-none focus:shadow-outline"
              >
                Login
              </button>
            </div>
